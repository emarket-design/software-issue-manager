...
class P2P_Side_User extends P2P_Side {
	...
	function get_desc() {
		return __( 'Users', EMD_P2P_TEXTDOMAIN );
	}
	...
	function get_labels() {
		return (object) array(
			'singular_name' => __( 'User', EMD_P2P_TEXTDOMAIN ),
			'search_items' => __( 'Search Users', EMD_P2P_TEXTDOMAIN ),
			'not_found' => __( 'No users found.', EMD_P2P_TEXTDOMAIN ),
		);
	}
