...
class P2P_Box {
	...
	public function init_scripts() {
		...
		wp_localize_script( 'p2p-box', 'P2PAdmin', array(
			...
			'deleteConfirmMessage' => __( 'Are you sure you want to delete all connections?', EMD_P2P_TEXTDOMAIN ),
	...
	protected function render_create_connections( $post ) {
		...
		$data['tabs'][] = array(
			'tab-id' => 'search',
			'tab-title' => __( 'Search', EMD_P2P_TEXTDOMAIN ),
	...
	protected function post_rows( $current_post_id, $page = 1, $search = '' ) {
		...
		if ( $candidate->total_pages > 1 ) {
			$data['navigation'] = array(
				...
				'prev-label' =>  __( 'previous', EMD_P2P_TEXTDOMAIN ),
				'next-label' =>  __( 'next', EMD_P2P_TEXTDOMAIN ),
				'of-label' => __( 'of', EMD_P2P_TEXTDOMAIN ),
			);
		}
	...
	public function ajax_disconnect() {
		p2p_delete_connection( absint($_POST['p2p_id']) );
